        ...
        if (Schema::hasTable('learning_test_questions')) {
            ...
            $questions = [
                ...
                [
                    'test_id' => 3,
                    'is_active' => 1,
                    'question_title' => 'Kādi ir galvenie bruģa veidi un kādi ir to pielietojumi?',
                    'question_description' => 'Šis jautājums pārbauda, vai zināt dažādus bruģa veidus un to piemērošanas iespējas dažādos projektos.',
                    'answer_type' => 'select_option',
                    'points' => rand(1, 5),
                    'visual_content' => null,
                    'created_at' => now(),
                ...
                [
                    'test_id' => 3,
                    'is_active' => 1,
                    'question_title' => 'Kāds ir pirmais solis bruģēšanas procesa uzsākšanā?',
                    'question_description' => 'Noskaidro, kādi ir pirmie soļi bruģēšanas procesā, sākot no pamatu sagatavošanas.',
                    'answer_type' => 'text',
                    'points' => rand(1, 5),
                    'visual_content' => null,
                    'created_at' => now(),
                ...
                [
                    'test_id' => 3,
                    'is_active' => rand(0, 1),
                    'question_title' => 'Kādi materiāli parasti tiek izmantoti bruģēšanas pamatu sagatavošanai?',
                    'question_description' => 'Šis jautājums palīdz noteikt, vai saprotat, kādi materiāli nepieciešami, lai sagatavotu pamatus bruģēšanas darbiem.',
                    'answer_type' => 'select_option',
                    'points' => rand(1, 5),
                    'visual_content' => null,
                    'created_at' => now(),
                ...
                [
                    'test_id' => 3,
                    'is_active' => rand(0, 1),
                    'question_title' => 'Kāds ir galvenais iemesls, kāpēc bruģis var būt bojāts?',
                    'question_description' => 'Noskaidro, kādi ir galvenie iemesli, kāpēc bruģis var nolietoties vai sabojāties.',
                    'answer_type' => 'text',
                    'points' => rand(1, 5),
                    'visual_content' => null,
                    'created_at' => now(),
                ...
                [
                    'test_id' => 3,
                    'is_active' => 1,
                    'question_title' => 'Kāds ir efektīvs veids, kā tīrīt bruģētu virsmu?',
                    'question_description' => 'Uzzini, kādi ir labākie veidi, kā tīrīt un uzturēt bruģētu virsmu labā stāvoklī.',
                    'answer_type' => 'text',
                    'points' => rand(1, 5),
                    'visual_content' => null,
                    'created_at' => now(),
                ...
                [
                    'test_id' => 3,
                    'is_active' => rand(0, 1),
                    'question_title' => 'Kādi ir galvenie soļi bruģēšanas darbu pabeigšanai?',
                    'question_description' => 'Noskaidro, kādi ir pēdējie soļi bruģēšanas darbu pabeigšanai, lai nodrošinātu ilgmūžību un kvalitāti.',
                    'answer_type' => 'text',
                    'points' => rand(1, 5),
                    'visual_content' => null,
                    'created_at' => now(),
                ...
                [
                    'test_id' => 8,
                    'is_active' => 1,
                    'question_title' => 'What is Filament in Laravel?',
                    'question_description' => 'Select the most accurate description of Filament in Laravel.',
                    'answer_type' => 'select_option',
                    'points' => 1,
                    'visual_content' => null,
                    'created_at' => now(),
                ...
                [
                    'test_id' => 8,
                    'is_active' => 1,
                    'question_title' => 'Which command is used to install Filament in a Laravel project?',
                    'question_description' => 'Choose the correct command to install the Filament package.',
                    'answer_type' => 'select_option',
                    'points' => 1,
                    'visual_content' => null,
                    'created_at' => now(),
                ...
                [
                    'test_id' => 8,
                    'is_active' => 1,
                    'question_title' => 'Which command creats dashboard widget in Filament?',
                    'question_description' => 'Choose the correct command to create a dashboard widget in Filament.',
                    'answer_type' => 'select_option',
                    'points' => 1,
                    'visual_content' => null,
                    'created_at' => now(),
                ...
                [
                    'test_id' => 8,
                    'is_active' => 1,
                    'question_title' => 'How to add a custom action to a Filament table?',
                    'question_description' => 'Select the correct way to add a custom action (e.g., button) to a Filament table row.',
                    'answer_type' => 'select_option',
                    'points' => 1,
                    'visual_content' => null,
                    'created_at' => now(),
                ...
                [
                    'test_id' => 8,
                    'is_active' => 1,
                    'question_title' => 'How to create a custom Filament page?',
                    'question_description' => 'Choose the correct way to create a custom Filament page.',
                    'answer_type' => 'select_option',
                    'points' => 1,
                    'visual_content' => null,
                    'created_at' => now(),
                ...
                [
                    'test_id' => 8,
                    'is_active' => 1,
                    'question_title' => 'How to handle file uploads in a Filament form?',
                    'question_description' => 'Select the correct way to handle file uploads within a Filament form.',
                    'answer_type' => 'select_option',
                    'points' => 1,
                    'visual_content' => null,
                    'created_at' => now(),
                ...
                [
                    'test_id' => 8,
                    'is_active' => 1,
                    'question_title' => 'How to create a view page for a resource?',
                    'question_description' => 'Choose the correct way to create a view page for a resource in Filament.',
                    'answer_type' => 'select_option',
                    'points' => 1,
                    'visual_content' => null,
                    'created_at' => now(),
                ...
                [
                    'test_id' => 8,
                    'is_active' => 1,
                    'question_title' => "On which class can we call the ::make('description') method to create a description field?",
                    'question_description' => null,
                    'answer_type' => 'select_option',
                    'points' => 1,
                    'visual_content' => $imageInfo[1]['image_path'],
                    'created_at' => now(),
                    'updated_at' => now(),
                ],
                ...
                [
                    'test_id' => 8,
                    'is_active' => 1,
                    'question_title' => 'How can you add a hidden input field that will be submitted along with other form fields?',
                    'question_description' => 'Explain whether Filament can automatically generate form validation for form fields.',
                    'answer_type' => 'select_option',
                    'points' => 1,
                    'visual_content' => $imageInfo[2]['image_path'],
                    'created_at' => now(),
                    'updated_at' => now(),
                ],
                [
                    'test_id' => 8,
                    'is_active' => 1,
                    'question_title' => 'How to add additional styles to a table column in Filament?',
                    'question_description' => 'Explain how to add custom styles to a table column in Filament.',
                    'answer_type' => 'select_option',
                    'points' => 1,
                    'visual_content' => null,
                    'created_at' => now(),
                ...
                [
                    'test_id' => 8,
                    'is_active' => 1,
                    'question_title' => 'How to add translations to Filament resources using the lang folder?',
                    'question_description' => 'Choose the correct way to add translation.',
                    'answer_type' => 'select_option',
                    'points' => 1,
                    'visual_content' => null,
                    'created_at' => now(),
                ...
                [
                    'test_id' => 8,
                    'is_active' => 1,
                    'question_title' => 'What does the `afterStateUpdated()` method do in Filament?',
                    'question_description' => 'Choose the correct behavior of the `afterStateUpdated()` method in a Filament form.',
                    'answer_type' => 'select_option',
                    'points' => 1,
                    'visual_content' => null,
                    'created_at' => now(),
                ...
                [
                    'test_id' => 8,
                    'is_active' => 1,
                    'question_title' => 'How to define custom validation rules for a Filament form?',
                    'question_description' => 'Explain how to define and implement custom validation rules for a form in Filament.',
                    'answer_type' => 'select_option',
                    'points' => 1,
                    'visual_content' => null,
                    'created_at' => now(),
                ...
                [
                    'test_id' => 8,
                    'is_active' => 1,
                    'question_title' => 'what is displayed in the suffix part?',
                    'question_description' => 'Explain what is displayed in the suffix part of a component in Filament.',
                    'answer_type' => 'select_option',
                    'points' => 1,
                    'visual_content' => $imageInfo[3]['image_path'],
                    'created_at' => now(),
                    'updated_at' => now(),
                ],
                [
                    'test_id' => 8,
                    'is_active' => 1,
                    'question_title' => 'What are enums in Laravel?',
                    'question_description' => 'Select the correct definition and use case of enums in Laravel.',
                    'answer_type' => 'select_option',
                    'points' => 1,
                    'visual_content' => null,
                    'created_at' => now(),
                ...
                [
                    'test_id' => 8,
                    'is_active' => 1,
                    'question_title' => 'How to filter table records?',
                    'question_description' => 'Choose the correct way to add a filter to the table records.',
                    'answer_type' => 'select_option',
                    'points' => 1,
                    'visual_content' => null,
                    'created_at' => now(),
                ...
                [
                    'test_id' => 8,
                    'is_active' => 1,
                    'question_title' => 'How to dynamically update another form field data after a form field value is changed?',
                    'question_description' => 'Select the correct method to update another form field dynamically when a form field’s value changes.',
                    'answer_type' => 'select_option',
                    'points' => 1,
                    'visual_content' => null,
                    'created_at' => now(),
                ...
                [
                    'test_id' => 8,
                    'is_active' => 1,
                    'question_title' => 'What happens in the ->required() method for the password confirmation field?',
                    'question_description' => 'Answer whether Bootstrap is the default CSS library bundled with Filament for styling components and layouts.',
                    'answer_type' => 'select_option',
                    'points' => 1,
                    'visual_content' => $imageInfo[4]['image_path'],
                    'created_at' => now(),
                    'updated_at' => now(),
                ],
                [
                    'test_id' => 8,
                    'is_active' => 1,
                    'question_title' => 'How do you change the default colors to other default colors in the Filament panel?',
                    'question_description' => 'Explain the process of modifying the default color scheme in the Filament panel by using predefined color options from the framework.',
                    'answer_type' => 'select_option',
                    'points' => 1,
                    'visual_content' => null,
                    'created_at' => now(),
                ...
                [
                    'test_id' => 8,
                    'is_active' => 1,
                    'question_title' => 'How is the custom view page for a related resource integrated and made accessible through the URL?',
                    'question_description' => 'Explain how to integrate and access a custom view page for a related resource through the URL in Filament.',
                    'answer_type' => 'select_option',
                    'points' => 1,
                    'visual_content' => $imageInfo[5]['image_path'],
                    'created_at' => now(),
                    'updated_at' => now(),
                ]
            ];
